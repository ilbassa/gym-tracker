...
const latestSetLabel = (log: WeightLogWithSets) => {
  const latestSet = log.sets.at(-1)
  return latestSet ? ` · ${formatWeightSet(latestSet)}` : ''
}
